...
import { Card as AntdCard, Button, Carousel, Col, Row, Tag } from "antd";
            ...
            <Cards>
                ...
                <Col span={12} xs={24} sm={24} md={24} lg={12} xl={12}>
                    <Fade fraction={0.1}cascade damping={0.05}>
                        <Card
                            hoverable
                            // cover={<img alt="Harmonic Hustle" src="/images/HarmonicHustle.png" />}
                            cover={
                        ...
                        <CardDescription>
                            ...
                            <StyledTag bordered={false}>C</StyledTag>
                            <StyledTag bordered={false}></StyledTag>
                        </CardDescription>
                        </Card>
                        </Fade>
                    </Col>
                    <Col span={12} xs={24} sm={24} md={24} lg={12} xl={12}>
                        <Fade fraction={0.1}cascade damping={0.05}>
                                ...
                                >
                                <div className="cardTitle">Atomic Design Project</div>
                                <CardDescription>
                                    {`
